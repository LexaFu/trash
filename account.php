...
<div class="data_user">
	<div class="dt_u_ctn">
		...
		<input type="text" name="last_name" id="lst-nm" value="<?php echo $resultat['last_name'];?>">
		<label for="first_name">Prénom: </label>
		<input type="text" name="first_name" id="fst-nm" value="<?php echo $resultat['first_name']?>">
		<label for="username">Pseudo: </label>
		<input type="text" name="username" id="usnm" value="<?php echo $resultat['username'];?>">
		<label for="email">Email: </label>
		<input type="text" name="email" id="eml" value="<?php echo $resultat['email']?>">
		<label for="phone">Téléphone: </label>
		<input type="text" name="phone" id="phn" value="<?php echo $resultat['phone']; ?>">	
	</div>
	<div class="apt_ctn">
		<p id="apt_lst">Mes rendez-vous: </p>
		<?php 
		...
		<p>Vous avez un rendez-vous prévu pour le <?php echo $_GET['date_appointment']; ?> à <?php echo $_GET['hour_appointment']; ?>.</p>
